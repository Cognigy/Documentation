...
Einen Überblick über einige der wichtigsten Komponenten finden Sie in der folgenden Grafik:<img src="{{config.site_url}}ai/resources/images/platform-overview-cognigy.png" width="100%" style="margin-bottom: 5px">

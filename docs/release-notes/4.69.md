...
- Introduced [new global roles](../ai/administer/access/admin-center/access-control.md#before-you-begin), specifically designed for support purposes. These roles are: `fullSupportUser`, `basicSupportUser`, `projectAssigner`

...
- Added migration collation job that upgrades PostgreSQL Docker image to solve high vulnerabilities. This job will restart Postgres and the Live Agent pods in the Kubernetes cluster

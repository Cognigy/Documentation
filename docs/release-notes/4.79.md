...
- Added the [Advanced Parser](../ai/empower/knowledge-ai/text-extraction/text-extraction-with-advanced-parser.md) for Knowledge AI. This Parser is activated by default if configured for your installation 
- Added support for PPTX format in both the [Basic](../ai/empower/knowledge-ai/text-extraction/text-extraction-with-basic-parser.md) and [Advanced](../ai/empower/knowledge-ai/text-extraction/text-extraction-with-azure-ai.md) Parsers
...
- The feature [Atmosphere Sounds](../ai/build/node-reference/voice/voice-gateway/parameter-details.md#atmosphere-sounds) adds the possibility to insert additional audio tracks into the conversation. One common usage is to add background sounds of keyboards clicking to simulate an office environment.

...
- Fixed the issue where a handover to Live Agent was failing and could not transmit any messages
...
- Fixed the issue where typing status was sent multiple times due to reply box on-blur events

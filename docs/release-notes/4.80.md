...
- Fixed the issue where an existing `use_sips_scheme` property set in the Voice Gateway Self-Service Portal was overwritten by the database update script after a new release

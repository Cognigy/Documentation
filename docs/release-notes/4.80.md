...
- Added the authorization method [OAuth 2.0 for Microsoft Azure OpenAI](../ai/empower/llms.md#add-a-model). Note that this method is experimental and may encounter some issues

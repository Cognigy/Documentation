...
- Extended the functionality of the AI Copilot: Next Action Tile Node to include the [Knowledge Assist](../ai/build/node-reference/ai-copilot/next-action-tile.md) options
...
- Enabled the [AI Copilot Embedding URL](../ai/escalate/handover-reference/genesys-cloud-open-messaging.md) for the Genesys Open Message handover provider

...
- Added support for new [Webchat v3 settings](../webchat/v3/configuration/#persistent-menu) mode: Webchat v3 can be configured to [render Markdown, collate streamed output messages, and display messages as progressive stream](../webchat/v3/configuration.md#webchat-behavior)

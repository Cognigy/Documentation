...
Introduced [Global LLMs](../ai/administer/access/global-resources/overview.md) in the Admin Center, allowing assignment to any Project within your organization and streamlining LLM management across Projects.

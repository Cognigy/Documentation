...
!!! warning "Upcoming Feature Deprecations and Removals"
    ...
    - On April 1, 2025:
        - [Insights Beta API](https://api-trial.cognigy.ai/openapi#get-/insights/beta/messages/report/-queryHash-) will be deprecated. Instead, use the [Cognigy.AI OData endpoint](../ai/analyze/odata.md).
        - The [Cognigy.AI OData v2.3](../ai/analyze/odata.md#supported-versions) endpoint will no longer be available in 4.98 and later. It remains available in 4.97 and earlier. Switch to OData v2.4.

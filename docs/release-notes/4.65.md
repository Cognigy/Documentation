...
- Added [Aleph Alpha text generation model support](../ai/empower/llms.md#supported-models) for LLM Prompt Node & LLM-powered Answer Extraction
- Added the [Custom model](../ai/empower/llms.md#add-a-model) parameter for the OpenAI and Aleph Alpha LLM providers

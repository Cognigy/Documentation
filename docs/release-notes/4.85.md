...
- Updated the Webchat v3 widget to
- Updated Demo Webchat with the latest versions of Webchat v3
...
- Fixed the issue where Contact Profiles without `profile_id` could not be updated

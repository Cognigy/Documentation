...
- Added the opportunity to use [Genesys Notification Forwarder](../ai/deploy/endpoint-reference/genesys.md#optional-activate-agent-copilot) via the Genesys Endpoint

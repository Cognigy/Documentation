...
- Add `.extraEnvVars` to all containers of a template.
  Optionally, specify a list of extra environment variables to add to the container:
  Containers:
   - api-ban
   - api-server
   - billing-app

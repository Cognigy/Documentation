...
This release introduces the ability to [pin Projects](../ai/build/projects.md#pin-and-unpin-projects), allowing you to better organize your view when logging in to Cognigy.AI. The list of pinned Projects will be stored in the user profile, and we plan to expand the range of Cognigy.AI resources that can be pinned in the future.

...
This release introduces the capability to download content stored in Knowledge Sources in the [Cognigy TXT (CTXT) format](../ai/empower/knowledge-ai/ctxt.md#download-knowledge-sources-as-ctxt). This feature enables customers to share content from our Knowledge AI product more easily across teams and Projects. The exporter preserves the structure of Knowledge Chunks, ensuring that re-imported files maintain the original Chunk organization.

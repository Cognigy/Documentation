...
- Fixed the issue where outbound calls remain silent when a Node with Set Activity Parameters enabled and the default speech provider is triggered
...
- Added [Google Gemini](../ai/empower/llms/providers/google.md) and [AWS Bedrock](../ai/empower/llms/providers/amazon-bedrock.md) (Nova & Anthropic) support for [AI Agents](../ai/build/node-reference/ai/ai-agent.md)
- Added [support](../ai/empower/llms/model-support-by-feature.md) for the `gemini-1.5-pro` and the `gemini-1.5-flash` models
...
- Added the possibility to [pin or unpin Projects](../ai/build/projects.md#pin-and-unpin-projects) in the Project list

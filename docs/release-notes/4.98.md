...
!!! warning "Upcoming Feature Deprecations and Removals"
    ...
    - In December, 2025, OData v2.3 will be deprecated. Before this date, ensure a smooth transition by switching to the [Cognigy.AI OData v2.4](../ai/analyze/odata.md#supported-versions).

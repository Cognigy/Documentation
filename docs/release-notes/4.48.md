...
- [Live Agent dashboard](../insights/dashboards/live-agent.md) is available under the feature flag for public beta
...
- Added the [Containment Rate bar chart](../insights/dashboards/engagement.md#containment-rate-1) to the Engagement dashboard

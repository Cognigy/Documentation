...
- Added support for [Anthropic's LLMs](../ai/empower/llms.md#supported-models), including `claude` and `claude-instant`
- Added the capability to [test an LLM connection](../ai/empower/llms.md#add-a-model) 
...
- Improved the [Microsoft Azure OpenAI Connection type](../ai/empower/llms.md#add-a-model) in the LLM settings

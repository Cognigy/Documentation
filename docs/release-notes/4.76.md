...
- Added the environment variable PRIVATE_VOIP_NETWORK_CIDR to sbc-inbound and sbc-outbound Deployments. This variable can be used for a private network (e.g. '172.31.0.0/16')

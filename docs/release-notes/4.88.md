...
- Added the capability to enable the [Flow Input Timeout](../ai/build/node-reference/voice/voice-gateway/parameter-details.md#flow-input-timeout) feature within the [AudioCodes Compatibility mode](../voice-gateway/migrate-from-ac-to-vg.md)

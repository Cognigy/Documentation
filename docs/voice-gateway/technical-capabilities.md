...
| SIPS                                                           | SIP over TLS signaling, as specified in [IETF RFC 3261](https://datatracker.ietf.org/doc/html/rfc3261). Voice Gateway supports TLS 1.0 and later versions. TLS 1.3 is preferred for optimal security. |

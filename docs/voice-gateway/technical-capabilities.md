...
| TLS                                                            | The Transport Layer Security (TLS) is a cryptographic protocol that provides secure communication over a network. Voice Gateway supports TLS 1.0 and later versions. TLS 1.3 is preferred for optimal security. |

...
| bidirectionalAudio.sampleRate| Is required for audio streaming.                                                                                                                                                                                                                         | No       |
| bidirectionalAudio.streaming | If this parameter is `true`, it enables audio streaming from your application to Jambonz (and to the remote caller). The default value is `false`.                                                                                                    | No       |

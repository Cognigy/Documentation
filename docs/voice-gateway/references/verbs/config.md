...
| boostAudioSignal           | A string or integer value indicating the number of decibels to boost or reduce the outgoing audio signal strength, e.g. "-6 dB". Note that this applies to the main track only, not to any dub tracks. | No                        |

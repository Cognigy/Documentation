...
<figure>
<img src="{{config.site_url}}assets/img/LA-reports-resolution-count.png" width="100%" alt="Resolved Count Report Screen" />
...
<figure>
<img src="{{config.site_url}}assets/img/LA-reports-download-agent-reports.png" width="100%" alt="Download Report Button " />
  <figcaption>Download Report</figcaption>
</figure>


<figure>
<img src="{{config.site_url}}assets/img/LA-reports-csv-file.png" width="100%" alt="Downloaded Report  in CSV File format " />

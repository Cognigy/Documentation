...
You need to create a new Inbox. To do that, use the [Adding an Additional Inbox for your Project](../ai/handover-providers/live-agent-setup/live-agent-setup-additional-inbox.md) article.

...
title: "Deploy Live Agent using Helm Charts"
---
# Deploy Live Agent using Helm Charts

This guide will help you to deploy a production ready Live Agent instance with Helm Charts.
...
The command deploys Live Agent on the Kubernetes cluster in the default configuration. The [parameters](#parameters) section lists the parameters that can be configured during installation.
...
### Live Agent Image parameters

| Name                | Description                                          | Value                 |
| ------------------- | ---------------------------------------------------- | --------------------- |
| `image.repository`  | Live Agent image repository                           | `chatwoot/chatwoot`    |
| `image.tag`         | Live Agent image tag (immutable tags are recommended) | `v18.1.1`              |
| `image.pullPolicy`  | Live Agent image pull policy                          | `IfNotPresent`         |


### Live Agent Environment Variables
...
| `env.CHATWOOT_INSTALLATION_ENV`     | Sets Live Agent installation method.                                  | `"helm"`                                                   |
...
| `env.POSTGRES_DB`                   | Live Agent database name                                                        | `"chatwoot_production"`                          |
...
The above command sets the Live Agent server frontend URL to `chat.yourdoamain.com`.

...
| Chat Interface Background | This parameter is currently unavailable and will be released soon.<br> The background color for the chat interface.                 |
| AI Agent Message          | This parameter is currently unavailable and will be released soon.<br> The background color for the agent messages.                 |
| User Message Background   | This parameter is currently unavailable and will be released soon.<br> The background color for the user messages.                  |
| Text Link                 | This parameter is currently unavailable and will be released soon.<br> Color in which text links within messages will be displayed. |

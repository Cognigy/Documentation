...
| Chat Interface Background | This feature is currently unavailable and will be released soon.<br> The background color for the chat interface.                 |
| AI Agent Message          | This feature is currently unavailable and will be released soon.<br> The background color for the agent messages.                 |
| User Message Background   | This feature is currently unavailable and will be released soon.<br> The background color for the user messages.                  |
| Text Link                 | This feature is currently unavailable and will be released soon.<br> Color in which text links within messages will be displayed. |
...
| Parameter                              | Description                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Maximum Number of Input Rows           | The maximum limit of lines that can be entered into the text input field. If the text exceeds this limit, a vertical scrollbar will automatically appear for easy navigation through the input text.                                                                                                                                                        |
| Enable Input Collation                 | This parameter combines typed inputs from the input field into a single message after a one-second delay without new text input. Immediate feedback or rapid responses are sent right away, prompting the transmission of any grouped messages immediately afterward.                                                                                       |
| Input Collation Timeout                | This parameter enables you to specify the time delay before the chatbot groups together typed inputs. If users don't type anything new within this time frame, their previous inputs are consolidated into a single message. This approach ensures a complete message context, especially when users type slowly or send multiple related messages at once. |
| Dynamic Image Aspect Ratio             | The images displayed in the gallery, attachment, or list output types will maintain their original proportions, filling the display area width without cropping or distortion.                                                                                                                                                                              |
...
| Input Placeholder Text             | This parameter enables you to customize the placeholder text in the message input field, indicating where users can type their messages to interact with the virtual agent. By default, it is set to `Type something…`                                                                                                                                                |
...
| Focus Input after Postback         | This parameter ensures that after a Postback button or quick reply button is clicked, Webchat immediately redirects focus back to the message input field. This function enhances usability by providing a smoother, streamlined user experience, allowing you to continue typing without having to manually click back into the text input field.                    |
...
| Enable Unread Message Badge           | This parameter displays a badge on the Webchat toggle button, showing the count of unread messages. This approach ensures users are aware of any new messages or responses from the virtual agent that they have yet to view, promoting timely and responsive interactions.      |
...
| Parameter                          | Description                                                                                                                                                                                    |
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Enable Previous Conversations      | This parameter displays a Previous Conversations button on the home screen, allowing users to access past conversations with the virtual agent within the last 30 days using the same browser. |

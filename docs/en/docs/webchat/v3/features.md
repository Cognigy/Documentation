...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/previous-conversations.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/chat-options.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/privacy-notice.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/adaptive-card.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/gallery.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/list.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/audio.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/image.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/video.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/text-with-buttons.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/attachment.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}webchat/images/v3/date-picker.png" width="100%" />
</figure>

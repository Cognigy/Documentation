...
|--|--|
|Understood messages|	This percentage value, displayed as a report arranged in a tile, relates to the evaluated messages and is helpful to improve your agent in natural language understanding. <br> The "null" value is available for messages with active handover. Messages marked as "null" are not counted in this chart. <br>Clicking on the three dots menu item you can select the "Go to [Intent Trainer]({{config.site_url}}ai/resources/tweak/intent-trainer/)" option that leads you to the Intent Trainer in Cognigy.AI to improve your Agent.|
...
|Understood/Misunderstood Messages|	This stacked bar chart shows bars on a timeline (per month) which figures out in percentage the understood /misunderstood messages in conversations. Tooltip info displays the exact number, percentage value, and month.<br>The "Understood" values form the lower parts of the stacked bar chart. <br> The "null" value is available for messages with active handover. Messages marked as "null" are not counted in this chart. <br>Clicking on the three dots menu item you can select the "Go to [Intent Trainer]({{config.site_url}}ai/resources/tweak/intent-trainer/)" option that leads you to the Intent Trainer in Cognigy.AI to improve your Agent.|

...
|Avg. Conversation length|	Average call duration (the report is arranged in a tile).|
...
|Max. Conversation length|	The maximum duration of conversations. (the report is arranged in a tile).|

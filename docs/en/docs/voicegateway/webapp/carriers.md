...
!!! warning
    The user with an Account scope can only edit carriers created by themselves, but they can still use and view carriers shared by Speech providers or Admins.
...
| Outbound Authentication    | Using a username and a password for the authentification.                                         | Account, Service Provider, Admin|

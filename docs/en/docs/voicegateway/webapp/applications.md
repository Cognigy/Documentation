...
|--------------------------|--------------------------------------------------------------------------------------|---------------------------------|
| Application Name         | A unique application name.                                                           | Account, Service Account, Admin |
| Account                  | Select an account from the list.                                                     | Account, Service Account, Admin | 
| Calling Webhook          | A Cognigy.AI Endpoint URL for the Web Application that will handle calls.            | Account, Service Account, Admin |
| Call Status Webhook      | A Cognigy.AI Endpoint URL for the Web Application that will receive the call status. | Account, Service Account, Admin | 
| Speech synthesis vendor  | Select a default Vendor and set up Language Settings for Text-To-Speech output.      | Account, Service Account, Admin | 
| Speech recognizer vendor | Select a default Vendor and set up Language Settings for Speech-To-Text recognition. | Account, Service Account, Admin |

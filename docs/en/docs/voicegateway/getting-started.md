...
# Getting Started with VoiceGateway
 ...
 <figure>
  <img class="image-center" src="{{config.site_url}}voicegateway/images/cognigy-vg-logo.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}voicegateway/images/voicegateway-nodes-overview.png" width="100%" />
</figure>
...
<figure>
  <img class="image-center" src="{{config.site_url}}voicegateway/images/voicegateway-new-endpoint.png" width="100%" />
</figure>

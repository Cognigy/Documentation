...
| service-nlp-score | Implement intent recognition based on [Intent models]({{config.site_url}}ai/nlu/nlu-overview/overview/) our customers can train within our platform. Different variants for various different languages exist (German, English, Korean, Japanese, Generic, XX). |

...
| [Voice Copilot](../../endpoints/voice-copilot.md)                                          | The Voice Copilot Endpoint is used for integration between [AI Copilot](../../agent-assist/overview.md) and [Genesys Cloud](https://apps.mypurecloud.de/).                                                                 |

...
Locales as separate resources are not imported along with the Flow. However, the localized content within Node configurations, default replies, and intent sentences is included in the import process.

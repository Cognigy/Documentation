...
Do not use Packages for deploying Knowledge to a production project, as there may be a temporary unavailability of virtual agents' Knowledge during the replacement of Knowledge Stores as part of the import process.

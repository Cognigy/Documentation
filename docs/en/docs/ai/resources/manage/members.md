...
| Knowledge Admin        | ![Version badge](https://img.shields.io/badge/Added in-v4.75.0-blue.svg) Adds the following permissions: full permissions for the [Knowledge AI](../../knowledge-ai/overview.md) resources                                                                                                                                  | 

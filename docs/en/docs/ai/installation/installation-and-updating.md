...
Installing our product requires our installation-guide, which you can download using this link: [https://docs.cognigy.com/downloads/cognigy-4-x-rev8.zip]({{config.site_url}}downloads/cognigy-4-x-rev8.zip)
...
| Enable Copilot | Toggle        | Turn on Copilot by providing a valid Transcription Webhook and a Header Key. AI Copilot requires a valid Transcription Webhook and a Header Key. This setting requires a configured [Voice Copilot](../../endpoints/voice-copilot.md) Endpoint.                                                                         |
...
| Disable STT Punctuation | Toggle        | This parameter is active only when Google is selected in the STT Vendor setting.<br><br> Prevents the STT response from the virtual agent to include punctuation marks.                                                                                                                                                                                                                                                                                                                                                                                           | Dial          |
| Deepgram Tier           | Selector      | This parameter is active only when Deepgram is selected in the STT Vendor setting. <br><br> Choose a model level for your API request, and ensure that the model is available for the chosen STT language. For detailed information about Deepgram tiers, refer to the [Deepgram documentation](https://developers.deepgram.com/docs/tier).                                                                                                                                                                                                                       | Dial          |

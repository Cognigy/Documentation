...
| Custom                     | CognigyScript | Allows for specifying a TTS voice that is not available in the dropdown list. This setting may be necessary for region-specific voices. The format to use depends on the TTS Vendor, for example, `de-DE-ConradNeural`.<br><br> The **Custom** field appears if you selected **Custom** from the **TTS Vendor** list.                                                                                                                                                                                                                                                                                                                             |
...
| Custom                          | CognigyScript | Allows for specifying an STT Vendor, which is not in the dropdown list. This setting can be the case for region-specific voices. The format to use depends on the STT Vendor, for example, `de-DE-ConradNeural`. <br><br> The **Custom** field appears if you selected **Custom** from the **STT Vendor** list. |

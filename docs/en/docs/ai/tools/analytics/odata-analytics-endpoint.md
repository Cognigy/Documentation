...
=== "OData 2.3"
    ...
    | Returns the first 10 Analytics records                                                              | `https://odata-trial.cognigy.ai/v2.3/Analytics?apikey=YOURAPIKEY`                                                                                          |
...
=== "OData 2.2 and earlier"
    ...
    | Returns the first 10 Inputs records                                                              | `https://odata-trial.cognigy.ai/v2.2/Inputs?apikey=YOURAPIKEY`                                                                                          |

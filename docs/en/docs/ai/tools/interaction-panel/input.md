...
The input object is passed to the Agent's [Flow](../../../ai/resources/build/flows.md) to decide on the next action to take. For more information about the lifespan of the input, see the [CognigyScript](../../../ai/tools/cognigy-script.md) page.
...
| entrypoint                       | This property varies based on Snapshot usage:<br> - The `Project/Agent ID` when no Snapshot is used.<br> - The Snapshot ID when a Snapshot is used.object.                                                                                                                                                                                                                         |
...
| intentLevel                      | The matched Intent, per [Intent Hierarchy](../../../ai/nlu/nlu-overview/intent-hierarchy.md) level.                                                                                                                                                                                                                                                                                |
...
| nlu                              | Contains the detailed NLU processing results. See [NLU Properties](../../../ai/tools/interaction-panel/input/#nlu-properties) for detailed information.                                                                                                                                                                                                                            |
...
Flow nodes can dynamically access Input properties via [Tokens](../../../ai/resources/manage/tokens.md) or [CognigyScript](../../../ai/tools/cognigy-script.md) i.e. `{{ " {{input.property}}" }}`. The Cognigy Script used to access the input object follows the dot-notation `property.child.child`.
...
- [State](../../../ai/tools/interaction-panel/state.md)
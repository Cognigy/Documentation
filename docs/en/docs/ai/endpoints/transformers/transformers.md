...
Transformers, like Code Nodes, can use the `getTextCleaner` function to retrieve an instance of the [Text Cleaner]({{config.site_url}}ai/tools/text-cleaner/) class which exposes functions for cleaning text.

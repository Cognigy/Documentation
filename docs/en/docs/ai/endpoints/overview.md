...
|---------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| [Cognigy Webchat](webchat/webchat.md)                   | The Webchat is an open-source web-based chat widget that can be embedded on any website.                                       |
...
| [Azure Bot Services](azure-bot-services.md)                                | The [Azure Bot Services](../../endpoints/azure-bot-services.md) Endpoint allows you to connect your Virtual Agent to all Azure Bot Service channels.                                      |
...
- Snapshot (info: Either use a Snapshot or the working state of the Agent)
- Flow [you can click on AI symbol to select defaut tokens]
  - Select from Dropdown
  - Manual input
- Locale
- Configuration Information
 - Endpoint URL
- Natural Language Understanding - NLU Connector
- Enable Endpoint

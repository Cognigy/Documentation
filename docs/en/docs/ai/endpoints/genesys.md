...
Now, you can design the flow and [configure inbound message flow](https://help.mypurecloud.com/articles/inbound-message-flows/) settings.
...
13. Click **Save**. Your deployment will appear in the deployment list.

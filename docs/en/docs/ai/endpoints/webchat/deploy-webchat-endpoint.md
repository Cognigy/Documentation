...
| Message History Rating Text | The text displayed in the message history after giving a rating (a text is followed by the icon representing the rating). |
| Message History Comment Text | The text displayed in the message history after giving a rating, if there was a comment sent (a text is followed by the actual comment). |

...
Cognigy.AI comes with a large number of inbuilt Nodes to control the AudioCodes behaviour. See [AudioCodes Nodes](../../ai/nodes/voice/audiocodes/overview.md) for more information.

## Number Meta Data

AudioCodes identifies information about the caller and adds it to the Cognigy [Input](../../ai/tools/interaction-panel/input.md) Object as `input.data.numberMetaData`.

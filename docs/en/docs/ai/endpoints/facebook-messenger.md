...
<figure>
  <img class="image-center" src="{{config.site_url}}ai/endpoints/images/a9627b5-FavebookProfilesSettings.PNG" width="100%" />
</figure>
...
???+ warning "Requires a Business"
    In order to perform the API calls necessary to get all of the PSIDs for the user, the same Business needs to own all of the Facebook Pages. More information at: [https://www.facebook.com/business](https://www.facebook.com/business)

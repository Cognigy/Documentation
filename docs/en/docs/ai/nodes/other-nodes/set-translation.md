...
<figure>
  <img class="image-center" src="{{config.site_url}}ai/nodes/images/other/set-translation.png" width="80%" />
</figure>
...
| Settings                                   | - **Label**: Enter a name for your choice to the Node. [Adding a Label](../node-usage.md#add-label) replaces the bottom text line of a Node.<br/>- **Comment**: [Additional information](../node-usage.md#add-comment) about the Node.<br/>- **Analytics step**: Enter a meaningful step name used as [Annotation](../../../insights/step-explorer.md#annotate-nodes) for the [Step Explorer](../../../insights/step-explorer.md) in [Insights](../../../insights/cognigy-insights.md) analytics. |

...
Within 8x8 integration, you can use [Agent Assist Workspace](../../ai-copilot/overview.md) as an assistant for your human agents. Agent Assist will be available as a standalone application via the following link:

`https://agent-assist-dev.cognigy.ai/?sessionId=<cognigy-session-id>&userId=<cognigy-user-id>&URLToken=<token-on-the-Cognigy-side>&organisationId=<Cognigy OrgID>&configId=<agent-assist-workspace-config-id>`
...
- [Agent Assist Workspace](../../ai-copilot/overview.md)
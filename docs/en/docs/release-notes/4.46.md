...
- Renamed the Complete Text Node to the [GPT Prompt](../ai/nodes/service/llm-prompt.md) Node
...
- Improved by rendering xApps submit payloads in the Live Follow session of the Interaction panel and Insights UI. To configure that, go to [Set HTML xApp State](../ai/nodes/xApp/set-html-xApp-state.md#description) or [Set AdaptiveCard xApp state](../ai/nodes/xApp/set-AdaptiveCard-xApp-state.md#description) Nodes

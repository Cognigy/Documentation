...
- Added the OAuth2 authentication method to the [Send SMTP Email](../ai/nodes/data/send-smtp-email.md#authentication) and [Email Notification](../ai/nodes/data/email-notification.md#authentication) Nodes
...
- Added the Wait for Input option in the [xApp: Show Adaptive Card](../ai/nodes/xApp/set-AdaptiveCard-xApp-state.md#waiting-behavior) and [xApp: Show HTML Nodes](../ai/nodes/xApp/set-html-xApp-state.md#waiting-behavior)

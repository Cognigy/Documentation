...
- Renamed the GPT Prompt Node to the [LLM Prompt](../ai/nodes/service/llm-prompt.md) Node
- Added the Pattern type to the [Question Node](../ai/nodes/basic/question.md), which allows for the convenient detection of various common patterns, such as license plates, IBAN and BIC numbers and more
...
- Added the [LLM Prompt Result](../ai/nodes/service/llm-prompt.md) Token for the Generative AI output of the LLM Prompt Node

...
- Added the Chat mode, LLM provider selection, and debugging options to the LLM Prompt Node
...
- Added the Deepgram speech provider to the Voice Gateway Self-Service Portal

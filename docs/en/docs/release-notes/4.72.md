...
- Added the capability to activate the Copy button within the Copilot: Next Action Tile and Copilot: Knowledge Tile Nodes for all handover providers except Live Agent. For Salesforce, ensure to update your Salesforce integrations using [this guide](https://github.com/Cognigy/salesforce-integrations?tab=readme-ov-file#update)

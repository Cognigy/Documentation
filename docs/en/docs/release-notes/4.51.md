...
- Fixed the issue where capturing DTMF did not work properly when activated via the SetSessionConfig Flow Node
...
- Fixed the issue preventing users from downloading the snapshot/packaged file due to corrupted size

...
- Added the handling of [Voice Gateway Call Events](../ai/endpoints/voice-gateway.md#call-events) via the [Lookup](../ai/nodes/logic/lookup.md#call-event-status) Node

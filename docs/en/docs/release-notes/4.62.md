...
- Added the [Context-Aware Search](../ai/nodes/other-nodes/search-extract-output.md#search-settings) option to the Search settings in the Search Extract Output Node. This feature considers the transcript's context for the search, allowing virtual agents to address follow-up questions
...
- Added the TTS Label and STT Label fields to the [Session Speech Parameters](../ai/nodes/voice/generic/session-speech-parameters-config.md) Node, [Voice Gateway Set Session Config](../ai/nodes/voice/voice-gateway/set-session-config.md) Node, [Voice Gateway Transfer](../ai/nodes/voice/voice-gateway/transfer.md) Node, [Cognigy Voice Gateway](../ai/endpoints/voice-gateway.md) Endpoint. This allows for the definition of preferred speech credentials configured on the Voice Gateway Self-Service portal directly within the Flow
- Added the Google Model field to the  [Session Speech Parameters](../ai/nodes/voice/generic/session-speech-parameters-config.md) Node, [Voice Gateway Set Session Config](../ai/nodes/voice/voice-gateway/set-session-config.md) Node, [Voice Gateway Transfer](../ai/nodes/voice/voice-gateway/transfer.md) Node, [Cognigy Voice Gateway](../ai/endpoints/voice-gateway.md) Endpoint. This allows selecting a specific speech model used for transcription.
- Improved the TTS error handling by adding more logging and a warning message

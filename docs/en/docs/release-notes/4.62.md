...
- Fixed the issue where `service-api` crashed during startup in environments that skipped version v4.61 and were updated from earlier versions to version 4.62

...
- Implemented the option to create a Webpage source type using the Knowledge AI wizard
- Added the [Error Handling](../ai/nodes/service/llm-prompt.md) section to the LLM Prompt Node
...
- Improved the HTTP Request Node by adding [Timeout and Retry Attempts](../ai/nodes/service/http-request.md) fields 
...
- Fixed the issue where JWT was exposed in the URL during WebSocket connections for the Interaction Panel (pr: !27835, !28275, !28291, ticket: #58346)

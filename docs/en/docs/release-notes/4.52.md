...
- Added the [Call Events section](../ai/endpoints/cognigy-vg.md#call-events) to the Voice Gateway endpoint. That enables handling call events such as `CALL_COMPLETION` and allows reacting with specific actions

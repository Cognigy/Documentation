...
- Added the [Adaptive Card](../ai/nodes/basic/say.md#adaptive-card) type to the Output Type list for the Say and Question Nodes
...
- Added the [Dial Transfer Type](../ai/nodes/voice/voice-gateway/transfer.md) to the Voice Gateway Transfer Node. If you want to use this update, add a new Voice Gateway Transfer Node in the Flow Editor and manually transfer the required settings from the old Node.

...
- Added the [Reprompt Methods](../ai/flow-nodes/message/question.md) to the Reprompt options in the Question Node
...
- Added the button to forward the next best action content from the AI Copilot widget to the Live Agent reply section. The improvement is in the [Copilot: Knowledge Tile](../ai/flow-nodes/ai-copilot/knowledge-tile.md#use-case) and [Copilot: Next Action Nodes](../ai/flow-nodes/ai-copilot/next-action-tile.md#use-case)

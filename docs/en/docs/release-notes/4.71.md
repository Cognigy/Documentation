...
!!! success "Cognigy.AI Handover problem solved in v4.71.4"
    This version solves an issue with an incorrect caching behavior of Cognigy.AI Handovers by deactivating the cache by default. If you are upgrading to this version, the following configuration which was necessary in older version of v4.71 is **NOT necessary**:
    ```yaml
    cognigyEnv:
        LRU_CACHE_ENABLED: "false"
    ```

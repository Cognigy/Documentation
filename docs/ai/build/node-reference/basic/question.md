...
| Money                                | Any monetary value (system-defined). The input needs to include the amount of money and the currency: <br> - The amount of money needs to be a number and its decimals need to be separated by the respective separator of the language, e.g. separate decimals with a dot for English and with a comma for German. <br> - The currency is accepted as a symbol or written out and can be written before the number.                                                                                                    | `300 euros`, `300,00 EUR`, `EUR 300` `300 €`, `€ 300`, `300 dollars`, `300.00 USD`, `USD 300`, `300 $`, `$ 300` |

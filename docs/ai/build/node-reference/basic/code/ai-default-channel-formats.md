...
As described in [Channel Output](channel-output.md), you can send JSON-formatted output directly against your [Endpoints](../../../../deploy/endpoints/overview.md) for it to be output to the respective channels.
...
<figure>
  <img class="image-center" src="../../../../../../_assets/ai/build/node-reference/code/adaptive-card.png" width="80%" />

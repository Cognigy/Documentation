...
The Complete Goal Node provides an easy way to track the completion of a specific event once the Node is triggered and can be used only with [Goals v1](../../../analyze/goals/v1.md).

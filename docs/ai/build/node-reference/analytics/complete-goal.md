...
3. If the customer selects B2 (No, I want to speak to an agent), handle this separately by triggering a Handover to Agent Node. In this case, you don't need to use the Complete Goal Node.

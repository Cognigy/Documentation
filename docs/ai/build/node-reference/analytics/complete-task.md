...
<figure>
  <img class="image-center" src="../../../../../_assets/ai/build/node-reference/analytics/complete-task.png" width="80%" />
</figure>
...
2. If the user selects B1 (Yes, my problem is resolved), connect it to a Complete Task Node. This Node will mark the "Successful AI Agent Conversation" task as completed, indicating that the AI Agent has effectively assisted the customer.

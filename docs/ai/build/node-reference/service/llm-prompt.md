...
<figure>
  <img class="image-center" src="../../../../../_assets/ai/build/node-reference/other/llm-prompt.png" width="80%" />
</figure>
...
Cognigy monitors for delimiter tokens ([Stream Output Tokens](#storage-and-streaming-options)),

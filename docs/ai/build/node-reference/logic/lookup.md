...
??? info "Intent"
    ...
    By default, the Intent at the most detailed [Intent Hierarchy](../../../empower/nlu/intents/intent-hierarchy/overview.md) level is matched. In this case, the Intents of all three levels are selectable in the Intent dropdown menu of the Case Nodes.

...
!!! note "Genesys Cloud"
    You can now receive **Status** messages from Genesys Cloud using the **Handover Status**. To learn how to do that, go to [Genesys Status / Bot Messages](../../../escalate/handover-reference/genesys-cloud-open-messaging.md).

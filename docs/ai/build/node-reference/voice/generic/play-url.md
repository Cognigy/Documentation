...
The Play URL Node might be useful when you want to stream an advertisement, a pre-recorded jingle or another sound file for the caller. MP3 and WAV encoded files are supported.

...
??? info "1. Top Bar"
    ...
    | Settings                                               | Tab  | Display the [Flow Settings](overview.md#settings), [Default Context](../ai-agent-memory/context.md), and [Locale Settings](../translation-and-localization/localization.md).                                                                                                                                                           |

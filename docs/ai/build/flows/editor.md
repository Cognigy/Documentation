...
The Flow editor allows for [Collaborative Editing](collaborative-editing.md). This means that multiple users can edit the same Flow at the same time.
...
??? info "1. Top Bar"
    ...
    | NLU                                                    | Tab  | Display the NLU settings, where you can configure [Intents](../../empower/nlu/intents/overview.md), [States](../../test/interaction-panel/state.md), [Slot Fillers](../../empower/nlu/slot-fillers.md), as well as attach [Flows](../../empower/nlu/overview.md#attached-flows) and [Lexicons](../../empower/nlu/slots/user-defined/lexicon.md). |

...
| Timeout                     | Number        | The amount of time (in seconds) that the virtual agent will ring before a [no-answer](../../../voice-gateway/references/events/NO_ANSWER.md) timeout. The default value is 60 seconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Dial          |

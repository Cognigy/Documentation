...
- `your-api-key` — an API key that provides authentication and authorization for accessing the API. You need to get this key from your [profile](../../ai/administer/user-menu/my-profile.md).
...
The OData endpoint supports the following [OData system query options](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html#sec_SystemQueryOptions):
...
Each collection can be filtered by its fields, which are often retrieved directly from the [Input](../build/ai-agent-memory/input.md) object results.

...
| service-nlp-ner                                 | Detects [System Slots](../empower/nlu/slots/system-defined.md) in user utterances - these are things like dates, emails, currencies and numbers.                                                                                     |
| service-nlp-matcher                             | Detects [Lexicon Slots](../empower/nlu/slots/system-defined.md) in user utterances using [Lexicons](../empower/nlu/slots/user-defined/lexicon.md).                                                                                  |

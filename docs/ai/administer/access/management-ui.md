...
| Analytics Expiration             | Determines how long (in minutes) an [Analytics](../../analyze/collecting-data.md) record persists in the Analytics database. Also this expiration date applies to data for [Goals v2](../../analyze/goals-and-tasks/overview.md).                                                                                                                                                     |

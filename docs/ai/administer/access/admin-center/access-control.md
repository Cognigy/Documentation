...
| `fullSupportUser`     | This role is assigned to users who require Admin-level privileges. However, within this role, they are unable to assign Projects or global roles to other users. Access to OData, Cognigy API, and Audit Event is included.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |

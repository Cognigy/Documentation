...
- [Project Roles](../access/members.md). These roles are specific to an Agent (project). You can assign project-level roles via the [Members Panel](../access/members.md) to extend user permissions for creating, editing, viewing, and updating entities within a specific Agent.
...
2. In the upper-right corner, click **User Menu ![user-menu](../../../_assets/icons/user-menu.svg) > Access Control**.
...
4. In the **New User** window, fill in the following fields:
    ...
    - **Password** — a user password. Passwords can be modified at any time and are securely stored. Users have the ability to change their passwords later by navigating **User Menu ![user-menu](../../../_assets/icons/user-menu.svg) >My Profile**.
...
3. Select a user you want to assign global roles to:
    ...
    === "New user"
        ...
        3.2 In the **New User** window, fill in the following fields:<br>
            ...
            - **Password** — a user password. Passwords can be modified at any time and are securely stored. Users have the ability to change their passwords later by navigating **User Menu ![user-menu](../../../_assets/icons/user-menu.svg) > My Profile**.<br>
...
- [Organization Details](../access/organization-details.md)
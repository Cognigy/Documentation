...
description: "_Source Tags_ serve to refine the scope of your knowledge search, allowing you to include only the most pertinent sections of the knowledge base and, as a result, improve the accuracy of search outputs."
hidden: false
---

# Knowledge Source Tags

_Source Tags_ serve to refine the scope of your knowledge search, allowing you to include only the most pertinent sections of the knowledge base and, as a result, improve the accuracy of search outputs. 
...
## Add Source Tags to Knowledge Source

You can add a Knowledge Source to the existing resource or to a new one.
...
=== "New Knowledge Source"
     ...
     8. Click **Browse files**, select a type from your computer and upload it. If you select **Web Page**, add a URL to the page that you want to upload.
     ...
     Once the Knowledge Source is created, the source tags will be availabe to view in the Tags column on the **Knowledge Sources** pages.
...
=== "Existing Knowledge Source"
     ...
     6. Click **Browse files**, select a type from your computer and upload it. If you select **Web Page**, add a URL to the page that you want to upload.
    ...
    Once you added Tags, they will be availabe to view in the Tags column on the **Knowledge Sources** pages.
...
7. Check if **Context-Aware Search** is activated in the **Search settings** section. This feature considers the context of the transcript for the search, allowing an AI Agent to address follow-up questions. Be aware that this feature will consume LLM tokens on your LLM prover side.

...
- You have added a [Large Language Model (LLM) to your Project](../llms/providers/all-providers.md) that [supports Knowledge Search and Answer Extraction](../../empower/llms/model-support-by-feature.md). For more details on how to add a model, read the [Generative AI](../generative-ai.md) documentation.

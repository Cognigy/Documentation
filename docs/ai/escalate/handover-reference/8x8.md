...
title: "8x8"
slug: "8x8-handover"
description: "The 8x8 handover provider bridges Cognigy.AI and 8x8, enabling end users to connect with human agents working within the 8x8 contact center." 
hidden: false
tags:
   - contact centers
   - 8x8
...
- Create an Endpoint [compatible with 8x8](../../deploy/endpoints/handover-settings.md#endpoints-compatible-with-handover-providers).

...
7. The HTML code contains the following entities:
    ...
    The Webchat v2 version must be higher than in which the Webchat features you use were introduced. Find out more about Webchat v2 versions in our [Webchat v2 release page](https://github.com/Cognigy/WebchatWidget/releases).
